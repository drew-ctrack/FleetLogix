      ...
      <section class="hero-banner" style="background-image: url(assets/img/hero-bg.jpg);">
        ...
        <div class="row">
          <div class="large-12 columns">
            <div class="half-content">
              <div class="background-image half left" style="background-image: url(assets/img/bus-bg.jpg);"><span class="gradient-overlay"></span></div>
              <div class="half content right">
                <h2>Lorem ipsum dolor sit amet, consectetur adipiscing elit. </h2>
                <p>Donec tincidunt lorem eu euismod egestas. Mauris eleifend nibh id ante suscipit euismod. Maecenas interdum pellentesque dolor, eget pellentesque nisl congue id. Nunc nec justo elementum,.</p>
                <p>Curabitur vestibulum, ipsum nec interdum facilisis, quam ante laoreet sem, id consequat metus risus eleifend felis. Morbi molestie dolor a consequat pretium. Pellentesque a dolor vel lacus posuere?</p>
      ...
      <section class="grid-links">
          ...
          <div class="large-4 medium-4 small-12 columns animate-box">
      			<a href="/" class="grid-image">
      				<span class="background-image" style="background-image: url(assets/img/tracking-bg.jpg);"></span>
      				<span class="overlay"></span>
              <span class="down-relative">
                <span class="down"></span>
              </span>
      				<h4>GPS Tracking Systems</h4>
      ...
      <section class="featured-solutions">
        ...
        <div class="row">
          ...
          <div class="large-3 medium-3 small-6 columns animate-box">
            <a href="/">
              <div class="product-image" style="background-image: url(assets/img/dashcam1.jpg);"></div>
              <div class="product-lower">
                <h5>Single Camera Dash Cam</h5>
              </div>
            </a>
          </div>
          <div class="large-3 medium-3 small-6 columns animate-box">
      ...
      <section class="home-content why-section animate-box">
        ...
        <div class="row">
          <div class="large-12 columns">
            <div class="half-content">
              <div class="background-image half right" style="background-image: url(assets/img/why-bg.jpg);"><span class="gradient-overlay"></span></div>
              <div class="half content left">
                ...
                <div class="why-container">
                  ...
                  <div class="why-content">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut facilisis luctus felis id ultrices. Vivamus sed varius leo, non bibendum magna.</p>
                  </div>
                </div>
                <div class="why-container">
                  <div class="why-icon">
      ...
      <section class="logos animate-box">
        <div class="row">
          ...
          <div class="large-3 medium-3 small-6 columns">
            <img src="assets/img/trust-logo1.jpg" alt="Company name logo">
          </div>
          <div class="large-3 medium-3 small-6 columns">
            <img src="assets/img/trust-logo2.jpg" alt="Company name logo">
          </div>
          <div class="large-3 medium-3 small-6 columns">
            <img src="assets/img/trust-logo3.jpg" alt="Company name logo">
          </div>
          <div class="large-3 medium-3 small-6 columns">
            <img src="assets/img/trust-logo4.jpg" alt="Company name logo">
          </div>
        </div>
      </section>
